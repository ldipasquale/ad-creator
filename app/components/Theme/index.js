...
class Theme extends React.Component {
  ...
  render() {
    return (
      <div>
        {this.state.highlightedElement && this.state.modifiers[this.state.highlightedElement.id] && (
          <AdFieldHandler
            onChange={modifiers => this.handleChangeModifiers(this.state.highlightedElement.id, modifiers)}
            type={this.state.highlightedElement.type}
            modifiers={this.state.modifiers[this.state.highlightedElement.id]}
            style={getHandlerPosition(this.state.highlightedElement, this.props.height)}
          />
        )}
