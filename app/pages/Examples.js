  ...
  render() {
    return (
      <div>
        ...
        {this.state.higlightedElement && (
          <div
            className="jampp__Ad__HighlightedItem"
            style={this.state.higlightedElement}
